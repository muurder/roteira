        ...
        <div className="max-w-md mx-auto mb-8">
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-full shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredFavorites.length > 0 ? (
            filteredFavorites.map((fav, index) => (
              <div key={index} className="bg-gray-50 rounded-lg shadow-md border border-gray-200 flex flex-col overflow-hidden transition-transform transform hover:-translate-y-1">
                <div className="p-6 flex-grow">
                  <div className="flex items-center mb-3">
                    <MapPinIcon className="w-6 h-6 text-blue-600 mr-2 flex-shrink-0" />
                    <h3 className="text-xl font-bold text-gray-800 truncate" title={fav.preferences.destination}>
                ...
                <div className="p-4 bg-gray-100 border-t border-gray-200 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="p-2 text-gray-500 bg-gray-200 rounded-md hover:bg-red-100 hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
            ...
            <div className="col-span-full text-center py-12">
              <p className="text-gray-600">Nenhum roteiro encontrado para "{searchTerm}".</p>
            </div>
          )}
        </div>
      </div>
